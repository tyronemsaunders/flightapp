/**
 * @desc calendar directive
 * @example <calendar selected="day"></calendar>
...
function calendar() {
	var directive = {
			...
			link: link,
			scope: {
				selected: "=" // "selected" corresponds to the directives isolate scope, "=" tells $compile to bind to selected on the outer scope <calendar selected="day"></calendar>
			}
	};
	return directive;
	
	// link registers DOM listeners and updates the DOM
	// scope in this directive references components/calendar/calendar.tpl.html
	function link(scope) {
